...
import { User, Mail, Lock, ArrowRight, Loader, Eye, EyeOff, UserPlus } from "lucide-react";
    ...
    <div className="min-h-screen bg-linear-to-br from-white via-gray-50 to-gray-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8 animate-fade-up">
          ...
          <p className="text-gray-600 text-lg">Create your account to begin managing tasks</p>
        </div>
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              <Lock className="absolute left-3 top-3.5 w-3 h-3 text-gray-400 group-focus-within:text-black transition-colors" />
              <input
        ...
        <p className="text-center text-gray-600 text-sm mt-6 animate-fade-up delay-300">
          By registering, you agree to our <span className="font-semibold text-gray-900">Terms of Service</span> and <span className="font-semibold text-gray-900">Privacy Policy</span>
        </p>
      </div>
    </div>
  );
